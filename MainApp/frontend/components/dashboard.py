...
from MainApp.frontend.components.score_display import display_overall_score, display_score_breakdown
from MainApp.frontend.components.strengths_issues import display_strengths, display_critical_issues
from MainApp.frontend.components.skill_validation import display_skill_validation
from MainApp.frontend.components.jd_comparison import display_jd_comparison
from MainApp.frontend.components.detailed_feedback import display_detailed_feedback
